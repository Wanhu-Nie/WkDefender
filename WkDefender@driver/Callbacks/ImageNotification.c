...
--*/
{
    ...
    /* === AppControl 镜像判定（通知型，AcCheckImageLoad） ===
...
// ============================================================================
// 死代码区 — 功能面全量覆盖（ImageNotify.c 行号），不接入流水线
// ============================================================================
//
...
// 本文件无配置入口。IMG_NOTIFY_CONFIG 定义于 ImageNotification.h 死代码区。
// ============================================================================
