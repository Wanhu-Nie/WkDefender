...
//
// 迁移新增（ImgFlag_*/ImgSuspicious_* 语义）
//
...
#define IMG_THREAT_UNBACKED             50      // PhantomDll
#define IMG_THREAT_ENTRYPOINT_OUTSIDE   50      // ProcessHollow
#define IMG_THREAT_KNOWN_VULNERABLE     80      // KnownVulnerable（死代码用）
...
// （经 ProcessMonitor.h 间接 include，消除 ImageNotification.h↔ProcessModuleTracker.h 依赖）
//
