...
#include "../Include/FileSystem/FileAnalyzer.h"  /* 文件类型判定 + 欺骗检测 (2026-09-14 迁入 FileAnalyzer.c) */
#include "Signature/SignatureVerifier.h"   /* IocVerifyTrust / IocScan_ReputationScore (验证签名模型) */
